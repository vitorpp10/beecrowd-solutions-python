'''
faça um programa que mostre na tela com delay de 0.05
e um closure de multiplicacao onde eu escolho o numero a ser multiplicado e ate que numero vai ser multiplicado
com textos
'''
